...
| [LRN-024](learnings/LRN-024.md) | 2026-09-13 | `Intl.DateTimeFormat(locale, { hour: "2-digit" })` seul renvoie une chaîne décorée, pas un nombre pur | #javascript #intl #timezone #date #parsing #lucide #ux              |
| [LRN-025](learnings/LRN-025.md) | 2026-09-13 | Un index mémoire lu en début de session peut être périmé au moment d'écrire                           | #memory-agent #id-collision #concurrent-session #git #workflow      |
